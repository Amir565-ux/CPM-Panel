...
def _load():
    if not os.path.exists(_DATA_FILE):
        return {"owner_key_hash": _OWNER_DEFAULT_HASH, "premium_keys": [], "features": dict(_DEFAULT_FEATURES), "activation_logs": []}
    try:
        ...
        return {"owner_key_hash": None, "premium_keys": [], "features": dict(_DEFAULT_FEATURES), "activation_logs": []}
