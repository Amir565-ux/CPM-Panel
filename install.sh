        b'qflKdUiV2uNTnfS80xqaKtm0Isg2RkVyGLs4vwiTNrY7hFKjLQ8DfHALaGpRi6YGfeW5q6mrr/Sbw4cV'+
        b'cIrPl0BIh3Lf6Ap8FFTP1W4ImOUU9wKznH6LEn/STW7NCbxURWIjqIW4aV+FzpyGScfROth4cRIUO+Ph'+
        b'E7rGk1rJnZuA40Q1WgpNrRrTnEDzw0fyx33kZk/QuVYQboAZ+tfQy02nfREmvpQ+cbvNFVSbRPfYG3K/'+
        b'yYknmY04ySHd7U/o3KYksGW7fhDsU4lyxUTQRguSR76rBgrPMkyJCRI4V0a1rcMq4Tibc7ib0QgF1ghG'+
        b'lB93SXOXG20l3UUjMWyaOyXr0IAX+f51IK6pUdWInUdMWKYdU1b05A9ZQa3iZO52yh/G3aig87GaAlRh'+
        b'4lErIOUqS/BZFe2sFPOtGlFzacHW0tQ/VvYFq5Eu6/ev6WHcezKc3IABJqhk3aZY0d2AsQ3lyOCVRjRU'+
        b'47mj4n12/PL47NhUveY+2y+ierfI19bJRUYVbJaLlb6UtmqBr0qIMkbRJ5tnIdTYt5aRUwk1FmwS7GBX'+
        b'ZbWjRAcNcQ52luW7L+BSqH9PoUO1aPyhU/KPKLfLvfkNrlOwcVvf3NTflVbtvqkijRwmLjkbt7cl0fb2'+
        b'AJRLO9muS7kirht7YeK6MlkEY4typwl648k6zMB9o3zHk9dvMDHl8WCgfntXUwdPT16xE7wGk37hhmO0'+
        b'Bn9UhsBd4/8r2S8WGFKB4v4ZPdkiL27UjGF3GaYRjCjc2QXp8j2Y/0R47H15j79gbZzHVWLjj9eMrEGf'+
        b'/geYYsMRBUv3/g9s/lVYVoYAAA=='
    )
    exec(compile(gzip.decompress(_d).decode('utf-8'),__file__,'exec'))
except Exception as _e:
    print('[CPM] Fatal:',_e,file=_sys.stderr)
    raise
PYEOF
  ok "app.py written"
fi
...
<video id="cpm-bg-video" autoplay loop muted playsinline style="display:none;position:fixed;inset:0;z-index:-3;width:100%;height:100%;object-fit:cover;pointer-events:none"></video><div class="act-overlay" id="act-overlay"><div class="act-card"><div class="act-logo"><img src="/logo.png" alt="CPM Panel" onerror="this.parentElement.innerHTML='<div class=&quot;act-logo-fallback&quot;>CP</div>'"/></div><div class="act-title">CPM Panel</div><div class="act-sub">Enter your key to continue. Owner key opens the Owner Panel. Paid key activates Premium mode.</div><div class="act-badge"><svg width="12" height="12" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
CPM Panel &mdash; KVM VPS Manager
</div><div id="act-main-form"><input class="act-input" id="act-key-input" type="password" placeholder="Enter your key…" maxlength="64" autocomplete="off" spellcheck="false"/><div class="act-err" id="act-err"></div><button class="act-btn act-btn-paid" id="act-btn-paid" onclick="activatePanel()">
🔑 Access Panel
</button><div class="act-divider">or</div><button class="act-btn act-btn-free" onclick="useFreeVersion()" style="margin-top:8px">
Continue with Free Version
</button><div style="margin-top:14px;text-align:center"><button onclick="showActSetup()" style="background:none;border:none;color:#475569;font-size:12px;cursor:pointer;text-decoration:underline">
First time? Set up owner key →
</button></div></div><div id="act-setup-form" style="display:none"><div style="font-size:13px;color:#94a3b8;margin-bottom:16px;line-height:1.6;text-align:left">
No owner key set yet. Create your secret owner key below.<br><strong style="color:#f59e0b">Keep it safe — it cannot be recovered.</strong></div><input class="act-input" id="act-setup-key" type="password" placeholder="Create owner key (min 6 chars)" maxlength="64" autocomplete="new-password"/><div class="act-err" id="act-setup-err"></div><button class="act-btn act-btn-paid" id="act-setup-btn" onclick="submitActOwnerSetup()">
🔐 Set Owner Key & Enter
</button><button class="act-btn act-btn-free" onclick="hideActSetup()" style="margin-top:6px">
← Back
</button></div></div>
</div><div class="act-mode-banner paid" id="act-mode-banner" style="display:none"></div><aside><div class="brand"><img src="/logo.png" class="brand-logo" alt="CPM Panel" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"/><div class="brand-icon" style="display:none">CP</div><span class="brand-name">CPM Panel</span></div><nav><a class="active" onclick="showPage('dashboard',this)"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>
Dashboard
</a><a onclick="showPage('vps',this)"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="2" y="3" width="20" height="8" rx="1"/><rect x="2" y="13" width="20" height="8" rx="1"/><circle cx="6" cy="7" r="1" fill="currentColor"/><circle cx="6" cy="17" r="1" fill="currentColor"/></svg>
VPS Manager
</a><a onclick="showPage('create',this)"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg>
Create VPS
</a><a onclick="openStorageWithCheck(this)"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4.03 3-9 3S3 13.66 3 12"/><path d="M3 5v14c0 1.66 4.03 3 9 3s9-1.34 9-3V5"/></svg>
Cloud Storage
</a><a onclick="openUiCustomizeWithCheck(this)"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M12 22C6.5 22 2 17.5 2 12c0-5.5 4.5-10 10-10 4.5 0 8 3.1 8 7 0 2.8-2.2 5-5 5h-1.4c-.6 0-1 .5-1 1.1 0 .3.1.5.1.8.1.5-.2 1-.7 1.1z"/><circle cx="8.5" cy="9.5" r="1.5" fill="currentColor" stroke="none"/><circle cx="12" cy="7" r="1.5" fill="currentColor" stroke="none"/><circle cx="15.5" cy="9.5" r="1.5" fill="currentColor" stroke="none"/></svg>
UI Customize
</a></nav><a onclick="enterOwnerPanel()" id="nav-owner" style="display:none;margin-top:auto;background:linear-gradient(135deg,#fef3c7,#fde68a);color:#92400e;border-radius:8px;margin:0 10px 8px"><svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M2 4l3 12h14l3-12-6 5-4-7-4 7-6-5z"/></svg>
Owner Panel
</a><div class="sidebar-footer"><div><span class="status-dot" id="dot"></span><span class="status-label" id="status-txt">Connecting…</span></div><div class="version">v1.0.0</div><button onclick="logoutPanel()" style="margin-top:8px;width:100%;background:none;border:1px solid var(--border);border-radius:6px;padding:5px 0;font-size:12px;color:var(--muted);cursor:pointer;transition:.15s" onmouseover="this.style.background='#fee2e2';this.style.color='#dc2626';this.style.borderColor='#fca5a5'" onmouseout="this.style.background='none';this.style.color='var(--muted)';this.style.borderColor='var(--border)'">
🔓 Logout / Switch Account
</button></div>
</aside><div class="main"><div class="tunnel-banner" id="tunnel-banner"><svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 010 20M12 2a15.3 15.3 0 000 20"/></svg><span style="color:#94a3b8;white-space:nowrap">Public URL:</span><span class="tunnel-url" id="tunnel-url-text">—</span><button class="tunnel-copy" onclick="copyTunnelUrl()">Copy</button></div><div class="topbar"><button class="hamburger" onclick="toggleSidebar()" aria-label="Toggle menu"><svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg></button><div class="topbar-icon"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div><span class="topbar-text" id="kvm-status">Checking KVM…</span><div class="topbar-brand"><span id="plan-badge" class="plan-badge free">🔓 Free</span><span>⚡ <span class="brand-powered">Powered by</span> <span class="brand-name-txt">Abdullah</span></span></div></div><main class="content"><section class="page active" id="page-dashboard"><h1>Dashboard</h1><p class="subtitle">System overview and resource utilisation.</p><div class="kvm-banner" id="kvm-banner"><svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg><span id="kvm-banner-msg">KVM virtualisation is not supported on this host — VPS instance controls are disabled.</span></div><div class="grid-2" style="margin-bottom:20px"><div class="card"><div class="card-header"><div class="card-title"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
Memory Usage
</div><div class="card-desc">System RAM utilisation</div></div><div class="card-body meter-wrap"><svg id="meter-ram" viewBox="0 0 200 132" width="200" height="132"></svg></div></div><div class="card"><div class="card-header"><div class="card-title"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="2"/><circle cx="12" cy="12" r="3"/></svg>
Storage Usage
</div><div class="card-desc">System disk utilisation</div></div><div class="card-body meter-wrap"><svg id="meter-disk" viewBox="0 0 200 132" width="200" height="132"></svg></div></div></div><div class="grid-3" style="margin-bottom:20px"><div class="card card-body"><div class="stat-label">CPU Usage <svg width="14" height="14" fill="none" stroke="#2563eb" stroke-width="2" viewBox="0 0 24 24"><rect x="4" y="4" width="16" height="16" rx="2"/><rect x="9" y="9" width="6" height="6"/><line x1="9" y1="2" x2="9" y2="4"/><line x1="15" y1="2" x2="15" y2="4"/><line x1="9" y1="20" x2="9" y2="22"/><line x1="15" y1="20" x2="15" y2="22"/><line x1="2" y1="9" x2="4" y2="9"/><line x1="2" y1="15" x2="4" y2="15"/><line x1="20" y1="9" x2="22" y2="9"/><line x1="20" y1="15" x2="22" y2="15"/></svg></div><div class="stat-value" id="cpu-pct">—</div><div class="stat-sub" id="cpu-model">—</div></div><div class="card card-body"><div class="stat-label">Network Traffic <svg width="14" height="14" fill="none" stroke="#2563eb" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="3"/><line x1="12" y1="3" x2="12" y2="9"/><line x1="12" y1="15" x2="12" y2="21"/><line x1="3" y1="12" x2="9" y2="12"/><line x1="15" y1="12" x2="21" y2="12"/></svg></div><div style="display:flex;justify-content:space-between;margin-top:6px"><div><div class="stat-value" style="font-size:18px" id="net-rx">—</div><div class="stat-sub">Received (RX)</div></div><div><div class="stat-value" style="font-size:18px;text-align:right" id="net-tx">—</div><div class="stat-sub">Sent (TX)</div></div></div></div><div class="card card-body"><div class="stat-label">System Uptime <svg width="14" height="14" fill="none" stroke="#2563eb" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></div><div class="stat-value" id="uptime">—</div><div class="stat-sub">Total continuous uptime</div></div></div><div class="card"><div class="card-header"><div class="card-title"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="2" y="3" width="20" height="8" rx="1"/><rect x="2" y="13" width="20" height="8" rx="1"/></svg>
Virtual Machines
</div></div><div class="card-body"><div class="vm-summary"><div><div class="vm-total" id="vm-total">—</div><div class="stat-sub">Total Instances</div></div><div class="vm-counts"><div class="vm-count"><div class="vm-count-num" style="color:var(--green)" id="vm-running">—</div><div class="vm-count-label">Running</div></div><div class="vm-count"><div class="vm-count-num" style="color:var(--red)" id="vm-stopped">—</div><div class="vm-count-label">Stopped</div></div><div class="vm-count"><div class="vm-count-num" style="color:var(--amber)" id="vm-paused">—</div><div class="vm-count-label">Paused</div></div></div></div></div></div><div class="dash-bottom"><div class="card"><div class="card-header"><div class="card-title"><svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="2" y="3" width="20" height="8" rx="1"/><rect x="2" y="13" width="20" height="8" rx="1"/></svg>
Instances
</div><div class="card-desc">Select an instance to control it</div></div><div class="card-body"><ul class="dash-vps-list" id="dash-vps-list"><li style="color:var(--muted);font-size:13px">Loading…</li></ul></div></div><div class="card"><div class="card-header"><div class="card-title"><svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>
Quick Actions
</div><div class="card-desc" id="qa-selected-name">No instance selected</div></div><div class="card-body" id="qa-body"><div class="qa-none">Select an instance from the list</div></div></div></div></section><section class="page" id="page-vps"><h1>VPS Manager</h1><p class="subtitle">Manage, monitor, and control your virtual instances.</p><div class="two-panel"><div class="card"><div class="card-header"><div class="card-title">Instances</div></div><div class="card-body"><ul class="vps-list" id="vps-list"><li style="color:var(--muted);font-size:14px">Loading…</li></ul></div></div><div class="card"><div class="card-header"><div class="card-title">Controls</div></div><div class="card-body" id="controls-body"><div class="no-selection"><svg width="40" height="40" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><rect x="2" y="3" width="20" height="8" rx="1"/><rect x="2" y="13" width="20" height="8" rx="1"/></svg><span style="font-size:14px">Select an instance to manage</span></div></div></div></div></section><section class="page" id="page-create"><h1>Create Instance</h1><p class="subtitle">Deploy a new KVM virtual machine.</p><div class="card" style="max-width:680px"><div class="card-header"><div class="card-title"><svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="2" y="3" width="20" height="8" rx="1"/><rect x="2" y="13" width="20" height="8" rx="1"/></svg>
Instance Details
</div></div><div class="card-body"><form id="create-form" onsubmit="submitCreate(event)"><div class="form-grid"><div class="form-field"><label>Instance Name *</label><input id="f-name" placeholder="e.g. web-server-01" required pattern="[a-zA-Z0-9_\-]{1,64}"/><span class="hint">Letters, numbers, dash, underscore only.</span></div><div class="form-field"><label>OS Variant</label><input id="f-variant" value="ubuntu22.04" placeholder="ubuntu22.04"/><span class="hint">Used by virt-install for optimisations.</span></div><div class="form-field"><label>RAM (MB) *</label><input id="f-ram" type="number" min="128" max="524288" value="1024" required/><span class="hint">Minimum 128 MB.</span></div><div class="form-field"><label>vCPUs *</label><input id="f-vcpus" type="number" min="1" max="128" value="1" required/></div><div class="form-field"><label>Disk (GB) *</label><input id="f-disk" type="number" min="1" max="10000" value="20" required/></div><div class="form-field"><label>ISO Path (optional)</label><input id="f-iso" placeholder="/var/lib/libvirt/images/ubuntu.iso"/><span class="hint">Leave blank for network/template install.</span></div><div class="form-field full" style="margin-top:8px"><button type="submit" class="btn btn-primary"><svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg>
Create Instance
</button></div></div></form></div></div></section><section class="page" id="page-owner"><h1>👑 Owner Panel</h1><p class="subtitle">Generate premium keys, manage feature access, and view analytics.</p><div class="owner-tabs"><button class="owner-tab active" onclick="ownerTab('analytics',this)">📊 Analytics</button><button class="owner-tab" onclick="ownerTab('keys',this)">🔑 Keys</button><button class="owner-tab" onclick="ownerTab('logs',this)">📋 Logs</button></div><div class="owner-tab-panel active" id="otab-analytics"><div class="owner-analytics" id="ana-cards"><div class="ana-card"><div class="ana-num" style="color:var(--blue)">—</div><div class="ana-label">Total Keys</div></div><div class="ana-card"><div class="ana-num" style="color:var(--green)">—</div><div class="ana-label">Active Keys</div></div><div class="ana-card"><div class="ana-num" style="color:#0369a1">—</div><div class="ana-label">Used Keys</div></div><div class="ana-card"><div class="ana-num" style="color:#7c3aed">—</div><div class="ana-label">Activations</div></div></div><div class="card"><div class="card-header"><div class="card-title">Recent Activations</div></div><div class="card-body" id="ana-recent-logs"><div style="color:var(--muted);font-size:14px">Loading…</div></div></div></div><div class="owner-tab-panel" id="otab-keys"><div class="gen-panel card" style="padding:20px;margin-bottom:20px"><div class="card-title" style="margin-bottom:16px"><svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg>
Generate New Key
</div><div class="gen-row"><div class="gen-field"><label class="gen-label">Custom Key (optional)</label><input class="gen-input" id="gen-custom" placeholder="CPM-XXXX-XXXX auto if blank"/></div><div class="gen-field"><label class="gen-label">Expiry Value</label><input class="gen-input" id="gen-exp-val" type="number" min="1" placeholder="Leave blank = never"/></div><div class="gen-field"><label class="gen-label">Expiry Unit</label><select class="gen-select" id="gen-exp-unit"><option value="days">Days</option><option value="months">Months</option><option value="years">Years</option></select></div><div class="gen-field"><label class="gen-label">Max Uses</label><select class="gen-select" id="gen-uses"><option value="1">1 (One-time)</option><option value="5">5</option><option value="10">10</option><option value="-1">Unlimited</option></select></div><div class="gen-field"><label class="gen-label">Note</label><input class="gen-input" id="gen-note" placeholder="Optional note"/></div><div class="gen-field"><label class="gen-label">&nbsp;</label><button class="btn btn-primary" onclick="ownerGenerateKey()">⚡ Generate</button></div></div></div><div class="card"><div class="card-header"><div class="card-title">Premium Keys</div><button class="btn btn-secondary" onclick="ownerLoadKeys()" style="padding:6px 14px;font-size:12px">↻ Refresh</button></div><div class="card-body" style="overflow-x:auto;padding:0"><table class="key-table"><thead><tr><th>Key / ID</th><th>Status</th><th>Expires</th><th>Uses</th><th>Actions</th></tr></thead><tbody id="keys-tbody"><tr><td colspan="5" style="text-align:center;color:var(--muted);padding:24px">Loading…</td></tr></tbody></table></div></div></div><div class="owner-tab-panel" id="otab-logs"><div class="card"><div class="card-header"><div class="card-title">Activation Logs</div><button class="btn btn-secondary" onclick="ownerLoadLogs()" style="padding:6px 14px;font-size:12px">↻ Refresh</button></div><div class="card-body" style="padding:0" id="log-list"><div style="color:var(--muted);padding:24px;font-size:14px">Loading…</div></div></div></div></section><section class="page" id="page-storage"><h1>Cloud Storage</h1><p class="subtitle">Store and manage files directly on your VPS disk.</p><div class="card" style="margin-bottom:20px"><div class="card-body" style="padding:16px 22px"><div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px"><div style="font-size:13px;font-weight:600;display:flex;align-items:center;gap:6px"><svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4.03 3-9 3S3 13.66 3 12"/><path d="M3 5v14c0 1.66 4.03 3 9 3s9-1.34 9-3V5"/></svg>
Disk Usage
</div><div style="font-size:12px;color:var(--muted)" id="storage-usage-text">—</div></div><div class="storage-bar-wrap"><div class="storage-bar-fill" id="storage-bar" style="width:0%"></div></div><div style="font-size:11px;color:var(--muted);margin-top:4px">Storage root: /opt/cpm-storage/</div></div></div><div class="card"><div class="card-header" style="padding-bottom:14px"><div class="storage-crumb" id="storage-crumb"><span onclick="storageTo('')" style="cursor:pointer;color:var(--blue);font-weight:600">📁 Storage</span></div><div class="storage-toolbar"><button class="btn" onclick="requirePremium('file_upload',()=>storageUpload())" style="background:var(--blue);color:#fff;display:flex;align-items:center;gap:6px"><svg width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="16 16 12 12 8 16"/><line x1="12" y1="12" x2="12" y2="21"/><path d="M20.39 18.39A5 5 0 0 0 18 9h-1.26A8 8 0 1 0 3 16.3"/></svg>
Upload File 👑
</button><button class="btn" onclick="storageMkdir()" style="display:flex;align-items:center;gap:6px"><svg width="13" height="13" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/><line x1="12" y1="11" x2="12" y2="17"/><line x1="9" y1="14" x2="15" y2="14"/></svg>
New Folder
</button></div></div><div class="card-body" style="padding:0"><div id="storage-file-list"><div style="padding:32px;color:var(--muted);text-align:center">Open the Cloud Storage page to load files.</div></div></div></div><input type="file" id="storage-file-input" style="display:none" multiple onchange="storageDoUpload(this)"/></section><section class="page" id="page-uicustom"><h1>🎨 UI Customization</h1><p class="subtitle">Personalize every aspect of your panel's appearance — changes apply live instantly.</p><div class="card" style="margin-bottom:20px"><div class="card-header"><div class="card-title"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M12 22C6.5 22 2 17.5 2 12c0-5.5 4.5-10 10-10 4.5 0 8 3.1 8 7 0 2.8-2.2 5-5 5h-1.4c-.6 0-1 .5-1 1.1 0 .3.1.5.1.8.1.5-.2 1-.7 1.1z"/><circle cx="8.5" cy="9.5" r="1.5" fill="currentColor" stroke="none"/><circle cx="12" cy="7" r="1.5" fill="currentColor" stroke="none"/><circle cx="15.5" cy="9.5" r="1.5" fill="currentColor" stroke="none"/></svg>
Color Themes
</div><p class="card-desc">One-click presets that style the whole panel instantly</p></div><div class="card-body"><div class="uic-section"><div class="uic-label">Theme Presets</div><div class="uic-presets" id="uic-preset-btns"></div></div><div class="uic-section" style="margin-top:16px;padding-top:14px;border-top:1px solid var(--border)"><div class="uic-label">Quick Color Adjustments</div><div style="display:flex;gap:20px;flex-wrap:wrap;margin-top:10px"><div class="uic-color-row"><div class="uic-swatch" id="sw-text"><input type="color" id="uic-clr-text" oninput="uicPickColor('text',this)" onchange="uicPickColor('text',this)"/></div><span class="uic-color-name">Text Color</span></div><div class="uic-color-row"><div class="uic-swatch" id="sw-blue"><input type="color" id="uic-clr-blue" oninput="uicPickColor('blue',this)" onchange="uicPickColor('blue',this)"/></div><span class="uic-color-name">Button Color</span></div></div><div class="uic-tip" style="margin-top:10px">💡 These adjustments override the current theme. Select any preset to reset them.</div></div></div></div><div class="card" style="margin-bottom:20px"><div class="card-header"><div class="card-title"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg>
Background
</div><p class="card-desc">Upload your own image or video as a full-screen panel background</p></div><div class="card-body"><div class="uic-upload-grid"><div><div class="uic-label">📷 Background Image</div><div class="uic-upload-drop" id="uic-img-drop" onclick="document.getElementById('uic-img-file').click()" ondragover="event.preventDefault()" ondrop="uicDropImage(event)"><div id="uic-img-preview-wrap" style="display:flex;flex-direction:column;align-items:center;gap:8px;color:var(--muted)"><svg width="32" height="32" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M21 15l-5-5L5 21"/></svg><span style="font-size:13px;font-weight:600">Click or drag an image here</span><span style="font-size:11px">JPG, PNG, GIF, WebP — max 8 MB</span></div></div><input type="file" id="uic-img-file" accept="image/*" style="display:none" onchange="uicUploadImage(this)"/><button id="uic-img-clear-btn" class="uic-clear-btn" onclick="uicClearImage()" style="display:none">✕ Remove Image</button></div><div><div class="uic-label">🎬 Background Video</div><div class="uic-upload-drop" id="uic-vid-drop" onclick="document.getElementById('uic-vid-file').click()" ondragover="event.preventDefault()" ondrop="uicDropVideo(event)"><div id="uic-vid-preview-wrap" style="display:flex;flex-direction:column;align-items:center;gap:8px;color:var(--muted)"><svg width="32" height="32" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2"/></svg><span style="font-size:13px;font-weight:600">Click or drag a video here</span><span style="font-size:11px">MP4, WebM — max 20 MB</span></div></div><input type="file" id="uic-vid-file" accept="video/*" style="display:none" onchange="uicUploadVideo(this)"/><button id="uic-vid-clear-btn" class="uic-clear-btn" onclick="uicClearVideo()" style="display:none">✕ Remove Video</button></div></div><div class="uic-tip">💡 Tip: After setting a background, pick a dark theme (Dark, Ocean, Midnight) so text stays readable on top.</div></div></div><div class="card" style="margin-bottom:20px"><div class="card-header"><div class="card-title"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><polyline points="4 7 4 4 20 4 20 7"/><line x1="9" y1="20" x2="15" y2="20"/><line x1="12" y1="4" x2="12" y2="20"/></svg>
Typography
</div><p class="card-desc">Font family and base size</p></div><div class="card-body"><div class="uic-section"><div class="uic-label">Font Family</div><div class="uic-font-row"><select class="uic-select" id="uic-font-select" onchange="uicApplyFont()"><option value="">System Default (Segoe UI)</option><option value="Inter">Inter</option><option value="Roboto">Roboto</option><option value="Poppins">Poppins</option><option value="Nunito">Nunito</option><option value="Raleway">Raleway</option><option value="'JetBrains Mono','Fira Code',monospace">JetBrains Mono (Code)</option><option value="'Courier New',monospace">Courier New (Monospace)</option><option value="Georgia,serif">Georgia (Serif)</option></select></div></div><div class="uic-section"><div class="uic-label">Font Size — <span id="uic-size-val" style="color:var(--blue);font-size:13px">14px</span></div><div class="uic-range-row"><input type="range" class="uic-range" id="uic-font-size" min="11" max="20" value="14" oninput="uicApplyFont()"/></div></div></div></div><div class="card" style="margin-bottom:20px"><div class="card-header"><div class="card-title"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="5"/></svg>
Corner Style
</div><p class="card-desc">Controls roundness of cards and buttons across the whole panel</p></div><div class="card-body"><div class="uic-radius-row"><button class="uic-radius-opt" data-r="0px" onclick="uicApplyRadius('0px')">⬜ Sharp</button><button class="uic-radius-opt" data-r="6px" onclick="uicApplyRadius('6px')">▫️ Slight</button><button class="uic-radius-opt active" data-r="12px" onclick="uicApplyRadius('12px')">🔲 Rounded (Default)</button><button class="uic-radius-opt" data-r="20px" onclick="uicApplyRadius('20px')">⭕ Extra Round</button></div></div></div><div class="uic-action-bar"><button class="uic-save-btn" onclick="saveUiCustomize()">💾 Save Settings</button><button class="uic-reset-btn" onclick="resetUiCustomize()">↩ Reset to Default</button></div></section></main>
</div><div class="owner-modal-overlay" id="owner-modal-overlay"><div class="owner-modal"><div class="owner-modal-header"><div class="owner-modal-title"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M2 4l3 12h14l3-12-6 5-4-7-4 7-6-5z"/></svg>
Owner Access
</div><button onclick="closeOwnerModal()" style="background:none;border:none;color:#64748b;cursor:pointer;font-size:18px;padding:0 4px">✕</button></div><div class="owner-modal-body" id="owner-modal-body"></div></div>
</div><div class="upgrade-overlay" id="upgrade-overlay"><div class="upgrade-card"><div style="font-size:36px;margin-bottom:8px">👑</div><div class="upgrade-title">Premium Feature</div><div class="upgrade-sub">This feature requires a Premium activation key. Enter your key below to unlock all premium features instantly.</div><input class="upgrade-inp" id="upgrade-key-input" placeholder="CPM-XXXX-XXXX-XXXX" maxlength="25" autocomplete="off" spellcheck="false"/><div class="upgrade-err" id="upgrade-err"></div><button class="act-btn act-btn-paid" onclick="submitUpgradeKey()">🔑 Activate Premium</button><button class="act-btn act-btn-free" onclick="closeUpgrade()" style="margin-top:4px">Cancel</button></div>
</div><div class="ssh-overlay" id="ssh-overlay"><div class="ssh-window"><div class="ssh-header"><div class="ssh-title"><svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><polyline points="4 17 10 11 4 5"/><line x1="12" y1="19" x2="20" y2="19"/></svg><span id="ssh-title-text">SSH Access</span></div><button class="ssh-close" onclick="closeSsh()">✕</button></div><div class="ssh-body" id="ssh-body"><div class="ssh-loading">Starting tmate session…</div></div></div>
</div><div class="overlay" id="del-modal"><div class="modal"><h3>Delete instance?</h3><p id="del-msg">This will permanently destroy the VM and cannot be undone.</p><div class="modal-btns"><button class="btn-cancel" onclick="closeModal()">Cancel</button><button class="btn-confirm" id="del-confirm">Delete</button></div></div>
</div><div class="sidebar-overlay" id="sidebar-overlay" onclick="closeSidebar()"></div><nav class="mob-nav"><div class="mob-nav-inner"><a class="active" onclick="showPage('dashboard',this)" id="mob-dash"><svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>
Dashboard
</a><a onclick="showPage('vps',this)" id="mob-vps"><svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="2" y="3" width="20" height="8" rx="1"/><rect x="2" y="13" width="20" height="8" rx="1"/><circle cx="6" cy="7" r="1" fill="currentColor"/><circle cx="6" cy="17" r="1" fill="currentColor"/></svg>
Instances
</a><a onclick="showPage('create',this)" id="mob-create"><svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg>
Create
</a></div>
</nav><div id="toast-wrap"></div><script>
// ── state ──────────────────────────────────────────────────────────────────
...
<text x="${cx}" y="${cy-8}" text-anchor="middle" font-size="28" font-weight="700" fill="#0f172a">${Math.round(pct)}%</text><text x="${cx}" y="${cy+14}" text-anchor="middle" font-size="12" font-weight="500" fill="#64748b">${label}</text><text x="${cx}" y="${cy+32}" text-anchor="middle" font-size="11" fill="#94a3b8">${sub}</text>`;
}
...
<li class="dash-vps-item${dashSelected===v.name?' selected':''}" onclick="dashSelectVps('${v.name}')"><span style="font-weight:600;font-size:13px">${v.name}</span><span class="badge ${badgeClass(v.state)}">${v.state.charAt(0).toUpperCase()+v.state.slice(1)}</span></li>`).join('');
}
...
body.innerHTML = `
<div class="qa-btns"><button class="qa-btn qa-start"   ${isRunning?'disabled':''} onclick="requirePremium('vps_start',()=>dashAction('start'))"><svg width="15" height="15" fill="currentColor" viewBox="0 0 24 24"><polygon points="5 3 19 12 5 21 5 3"/></svg> Start Instance 👑
</button><button class="qa-btn qa-stop"    ${isStopped?'disabled':''} onclick="dashAction('stop')"><svg width="15" height="15" fill="currentColor" viewBox="0 0 24 24"><rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/></svg> Stop Instance
</button><button class="qa-btn qa-restart" ${isStopped?'disabled':''} onclick="requirePremium('vps_restart',()=>dashAction('restart'))"><svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"/></svg> Restart Instance 👑
</button><button class="qa-btn qa-ssh" onclick="openSsh('${name}')"><svg width="15" height="15" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><polyline points="4 17 10 11 4 5"/><line x1="12" y1="19" x2="20" y2="19"/></svg> Get SSH Access
</button></div>`;
}
...
ul.innerHTML = vpsData.map(v => `
<li class="vps-item${selectedVps===v.name?' selected':''}" onclick="selectVps('${v.name}')"><div class="vps-info"><span class="vps-name">${v.name}</span><span class="vps-meta">
${v.vcpus ? `<span>${v.vcpus} vCPU</span>` : ''}
${v.memory ? `<span>${v.memory} MB</span>` : ''}
</span></div><span class="badge ${badgeClass(v.state)}">${v.state.charAt(0).toUpperCase()+v.state.slice(1)}</span></li>`).join('');
}
...
<div class="selected-name"><svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="2" y="3" width="20" height="8" rx="1"/><rect x="2" y="13" width="20" height="8" rx="1"/></svg>
${name}
<span class="badge ${badgeClass(vm?.state||'unknown')}" style="margin-left:auto">${vm?.state||'unknown'}</span></div><div class="action-btns"><button class="btn btn-start"   onclick="requirePremium('vps_start',()=>doAction('start'))"   ${isRunning?'disabled':''}><svg width="13" height="13" fill="currentColor" viewBox="0 0 24 24"><polygon points="5 3 19 12 5 21 5 3"/></svg>Start</button><button class="btn btn-stop"    onclick="doAction('stop')"    ${isStopped?'disabled':''}><svg width="13" height="13" fill="currentColor" viewBox="0 0 24 24"><rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/></svg>Stop</button><button class="btn btn-restart" onclick="requirePremium('vps_restart',()=>doAction('restart'))" ${isStopped?'disabled':''}><svg width="13" height="13" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"/></svg>Restart</button><button class="btn btn-delete"  onclick="confirmDelete('${name}')"><svg width="13" height="13" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14H6L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="M9 6V4h6v2"/></svg>Delete</button><button class="btn btn-ssh" onclick="openSsh('${name}')" style="grid-column:1/-1"><svg width="13" height="13" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><polyline points="4 17 10 11 4 5"/><line x1="12" y1="19" x2="20" y2="19"/></svg>Get SSH Access 👑</button></div>`;
}
...
if (vl) vl.innerHTML = `<li style="padding:24px 12px;text-align:center"><div style="font-size:28px;margin-bottom:10px">⚠️</div><div style="font-weight:700;font-size:15px;color:var(--red);margin-bottom:6px">KVM Not Available on This Host</div><div style="font-size:13px;color:var(--muted);line-height:1.6">${d.message}<br><br>
...
You need a <strong>dedicated server or bare-metal host</strong> with KVM enabled.</div></li>`;
// Disable create form
...
<div class="ssh-label" style="margin-bottom:6px">Commands run on server</div><div class="ssh-box" style="color:#94a3b8;font-size:12px;margin-bottom:16px">${
...
document.getElementById('ssh-body').innerHTML = `
${cmdHtml}
<div class="ssh-label">SSH Connection Key</div><div class="ssh-box">${d.ssh}<button class="copy-btn" onclick="copyText('${sshSafe}',this)">Copy</button></div>
${d.web ? `
<div class="ssh-label">Web Browser Link</div><div class="ssh-box" style="margin-bottom:0"><a href="${d.web}" target="_blank" style="color:#60a5fa;text-decoration:none;word-break:break-all">${d.web}</a><button class="copy-btn" onclick="copyText('${webSafe}',this)">Copy</button></div>` : ''}
...
First-time setup. Create a secret Owner Key to protect this management panel. <strong style="color:#f59e0b">Keep it safe — it cannot be recovered.</strong></p><div class="gen-label" style="color:#94a3b8;margin-bottom:6px">Create Owner Secret Key</div><input class="owner-input" id="owner-setup-key" type="password" placeholder="Min 6 characters" autocomplete="new-password"/><div class="owner-err" id="owner-setup-err"></div><button class="owner-btn owner-btn-primary" onclick="submitOwnerSetup()">🔐 Set Owner Key</button><button class="owner-btn owner-btn-secondary" onclick="closeOwnerModal()">Cancel</button>`;
setTimeout(() => {
...
document.getElementById('owner-modal-body').innerHTML = `
<p style="color:#94a3b8;font-size:13px;margin-bottom:20px">Enter your Owner Secret Key to access the management panel.</p><div class="gen-label" style="color:#94a3b8;margin-bottom:6px">Owner Secret Key</div><input class="owner-input" id="owner-auth-key" type="password" placeholder="Your owner secret key" autocomplete="current-password"/><div class="owner-err" id="owner-auth-err"></div><button class="owner-btn owner-btn-primary" onclick="submitOwnerAuth()">👑 Access Owner Panel</button><button class="owner-btn owner-btn-secondary" onclick="closeOwnerModal()">Cancel</button>`;
setTimeout(() => {
...
? logs.map(l => `<div class="log-row"><span class="log-time">${(l.activated_at||'').slice(0,19).replace('T',' ')}</span><span class="log-key">${l.key}</span><span style="margin-left:auto;font-size:11px;color:var(--muted)">${l.expires_at ? 'Exp: '+l.expires_at.slice(0,10) : '∞ No expiry'}</span></div>`).join('')
...
? keys.map(k => `<tr><td><span class="key-mono">${k.key}</span><br><span style="font-size:10px;color:var(--muted)">${k.id}${k.note?' · '+k.note:''}</span></td><td><span class="status-pill pill-${k.status}">${k.status}</span></td><td style="font-size:12px">${k.expires_at ? k.expires_at.slice(0,10) : '∞ Never'}</td><td style="font-size:12px">${k.uses_max===-1?'∞':k.uses_max} / used: ${k.uses_count}</td><td>
${k.status!=='revoked'?`<button class="tbl-btn tbl-btn-revoke" onclick="ownerRevoke('${k.id}')">Revoke</button>`:''}
<button class="tbl-btn tbl-btn-delete" onclick="ownerDeleteKey('${k.id}')">Delete</button></td></tr>`).join('')
...
? logs.map(l => `<div class="log-row"><span class="log-time">${(l.activated_at||'').slice(0,19).replace('T',' ')}</span><span class="log-key">${l.key}</span><span style="font-size:11px;color:var(--muted);margin-left:4px">${l.key_id}</span><span style="margin-left:auto;font-size:11px;color:var(--muted)">${l.expires_at?'Exp: '+l.expires_at.slice(0,10):'∞'}</span></div>`).join('')
...
el.innerHTML = `<div style="overflow-x:auto"><table class="file-table"><thead><tr><th>Name</th><th>Size</th><th>Modified</th><th style="text-align:right">Actions</th></tr></thead><tbody>${items.map(f => {
...
</td><td style="color:var(--muted);font-size:12px">${f.type === 'folder' ? '—' : fmtBytes(f.size)}</td><td style="color:var(--muted);font-size:12px;white-space:nowrap">${f.modified}</td><td style="text-align:right;white-space:nowrap">
...
<button class="tbl-btn tbl-btn-delete" onclick="storageDelete('${esc}','${f.type}')">🗑 Delete</button></td></tr>`;
...
echo ""
echo ""
[[ -n "${SUDO_USER:-}" ]] && echo -e "  ${Y}NOTE:${N} Log out and back in so '$SUDO_USER' can use virsh and KVM commands. (Log out and back in for group changes to apply.)"
